...
export default function HomePortfolio({ repos, gists }) {
  ...
  return (
    <section
      id="portfolio"
      className={classnames(styles.portfolio, 'container')}
    >
      ...
      <header className={classnames(styles.portfolio__header, 'mt-20')}>
        ...
        <p>
          ...
          da ich sie selbst jeden Tag produktiv nutze. Wenn du einen Fehler
          findest oder etwas verbessern kannst, dann nur her damit.
        </p>
      </header>
